export const ROUTES = {
  ...
  MACHINE_SHOWCASE: '/community/showcase',
  MACHINE_SHOWCASE_WRITE: '/community/showcase/write',
  MACHINE_SHOWCASE_DETAIL: '/community/showcase/:postId',
  MACHINE_DEX: '/my-page/machine-dex',
  ...
  ADMIN_MACHINE_SHOWCASE: '/admin/machine-showcase',
