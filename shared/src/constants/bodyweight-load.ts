...
export const BODYWEIGHT_LOAD_FACTORS: Readonly<Record<string, number>> = {
  ...
  // Reserved codes / future catalog — kept in SoT so admin seeds stay consistent.
  BW_STEP_UP: 0.8,
  BW_HINDU_SQUAT: 0.75,
  BW_PISTOL_SQUAT: 0.75,
  BW_INCLINE_PUSH_UP: 0.55,
  BW_DECLINE_PUSH_UP: 0.7,
  BW_PIKE_PUSH_UP: 0.7,
  BW_HANDSTAND_PUSH_UP: 0.8,
  BW_BENCH_DIPS: 0.75,
  BW_BURPEE: 0.7,
  BW_MOUNTAIN_CLIMBER: 0.5,
  BW_PLANK: 0.5,
  BW_SIDE_PLANK: 0.5,
  BW_CRUNCH: 0.5,
  BW_SIT_UP: 0.5,
  BW_LEG_RAISE: 0.55,
  BW_HANGING_LEG_RAISE: 1.0,
  BW_V_UP: 0.5,
  BW_RUSSIAN_TWIST: 0.5,
  BW_SUPERMAN: 0.5,
  BW_BACK_EXTENSION: 0.6,
  BW_GLUTE_BRIDGE: 0.6,
  BW_HIP_THRUST: 0.6,
  BW_CALF_RAISE: 0.9,
  BW_WALL_SIT: 0.75,
