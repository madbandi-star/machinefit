-- Seed foundation brands (29 OEM) + standard machine types (80).
-- Idempotent. Does NOT invent brand-specific product SKUs.
-- Depends on 132_standard_machine_catalog.sql

-- Foundation brands (29) + standard machine types (80)
-- Idempotent: ON CONFLICT upserts; does not invent brand products.

-- ===== Brands =====
INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'HAMMER_STRENGTH',
  '{"ko":"해머 스트렝스","en":"Hammer Strength","ja":"ハンマーストレングス","zh":"悍马力量"}'::jsonb,
  'https://www.hammerstrength.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  10,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'HAMMER_STRENGTH');

UPDATE brands SET
  name = '{"ko":"해머 스트렝스","en":"Hammer Strength","ja":"ハンマーストレングス","zh":"悍马力量"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.hammerstrength.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 10 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'HAMMER_STRENGTH';
...
SELECT
  ...
  20,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'LIFE_FITNESS');

UPDATE brands SET
  name = '{"ko":"라이프 피트니스","en":"Life Fitness","ja":"ライフフィットネス","zh":"力健"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.lifefitness.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 20 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'LIFE_FITNESS';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'NAUTILUS',
  '{"ko":"노틸러스","en":"Nautilus","ja":"ノーチラス","zh":"诺帝勒斯"}'::jsonb,
  'https://www.nautilus.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  30,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'NAUTILUS');

UPDATE brands SET
  name = '{"ko":"노틸러스","en":"Nautilus","ja":"ノーチラス","zh":"诺帝勒斯"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.nautilus.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
...
SELECT
  ...
  40,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'CYBEX');

UPDATE brands SET
  name = '{"ko":"사이벡스","en":"Cybex","ja":"サイベックス","zh":"赛百斯"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.cybexintl.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
...
SELECT
  'HOIST',
  '{"ko":"호이스트","en":"Hoist","ja":"ホイスト","zh":"霍伊斯特"}'::jsonb,
  'https://www.hoistfitness.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  50,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'HOIST');

UPDATE brands SET
  name = '{"ko":"호이스트","en":"Hoist","ja":"ホイスト","zh":"霍伊斯特"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.hoistfitness.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 50 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'HOIST';
...
SELECT
  'MATRIX',
  '{"ko":"매트릭스","en":"Matrix","ja":"マトリックス","zh":"乔山矩阵"}'::jsonb,
  'https://www.matrixfitness.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  60,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'MATRIX');

UPDATE brands SET
  name = '{"ko":"매트릭스","en":"Matrix","ja":"マトリックス","zh":"乔山矩阵"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.matrixfitness.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
...
SELECT
  'PRECOR',
  '{"ko":"프리코","en":"Precor","ja":"プリコール","zh":"必确"}'::jsonb,
  'https://www.precor.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  70,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'PRECOR');

UPDATE brands SET
  name = '{"ko":"프리코","en":"Precor","ja":"プリコール","zh":"必确"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.precor.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
...
SELECT
  'PRIME_FITNESS',
  '{"ko":"프라임 피트니스","en":"Prime Fitness","ja":"プライムフィットネス","zh":"Prime Fitness"}'::jsonb,
  'https://www.primefitnessusa.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  80,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'PRIME_FITNESS');

UPDATE brands SET
  name = '{"ko":"프라임 피트니스","en":"Prime Fitness","ja":"プライムフィットネス","zh":"Prime Fitness"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.primefitnessusa.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 80 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'PRIME_FITNESS';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'ARSENAL_STRENGTH',
  '{"ko":"아스날 스트렝스","en":"Arsenal Strength","ja":"アーセナルストレングス","zh":"Arsenal Strength"}'::jsonb,
  'https://www.arsenalstrength.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  90,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'ARSENAL_STRENGTH');

UPDATE brands SET
  name = '{"ko":"아스날 스트렝스","en":"Arsenal Strength","ja":"アーセナルストレングス","zh":"Arsenal Strength"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.arsenalstrength.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 90 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'ARSENAL_STRENGTH';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'FREEMOTION',
  '{"ko":"프리모션","en":"Freemotion","ja":"フリーモーション","zh":"Freemotion"}'::jsonb,
  'https://www.freemotionfitness.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  100,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'FREEMOTION');

UPDATE brands SET
  name = '{"ko":"프리모션","en":"Freemotion","ja":"フリーモーション","zh":"Freemotion"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.freemotionfitness.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 100 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'FREEMOTION';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'PARAMOUNT',
  '{"ko":"파라마운트","en":"Paramount","ja":"パラマウント","zh":"Paramount"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  110,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'PARAMOUNT');

UPDATE brands SET
  name = '{"ko":"파라마운트","en":"Paramount","ja":"パラマウント","zh":"Paramount"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 110 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'PARAMOUNT';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'ROGERS_STRENGTH',
  '{"ko":"로저스 스트렝스","en":"Rogers Strength","ja":"ロジャースストレングス","zh":"Rogers Strength"}'::jsonb,
  'https://www.rogersathletic.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1),
  120,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'ROGERS_STRENGTH');

UPDATE brands SET
  name = '{"ko":"로저스 스트렝스","en":"Rogers Strength","ja":"ロジャースストレングス","zh":"Rogers Strength"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.rogersathletic.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'US' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 120 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'ROGERS_STRENGTH';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'PANATTA',
  '{"ko":"파나타","en":"Panatta","ja":"パナッタ","zh":"Panatta"}'::jsonb,
  'https://www.panattasport.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'IT' LIMIT 1),
  130,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'PANATTA');

UPDATE brands SET
  name = '{"ko":"파나타","en":"Panatta","ja":"パナッタ","zh":"Panatta"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.panattasport.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'IT' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 130 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'PANATTA';
...
SELECT
  'GYM80',
  '{"ko":"짐80","en":"GYM80","ja":"GYM80","zh":"GYM80"}'::jsonb,
  'https://www.gym80.de',
  (SELECT id FROM countries WHERE UPPER(code) = 'DE' LIMIT 1),
  140,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'GYM80');

UPDATE brands SET
  name = '{"ko":"짐80","en":"GYM80","ja":"GYM80","zh":"GYM80"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.gym80.de'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'DE' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 140 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'GYM80';
...
SELECT
  ...
  150,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'TECHNOGYM');

UPDATE brands SET
  name = '{"ko":"테크노짐","en":"Technogym","ja":"テクノジム","zh":"泰诺健"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.technogym.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'IT' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 150 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'TECHNOGYM';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'ATLANTIS',
  '{"ko":"아틀란티스","en":"Atlantis","ja":"アトランティス","zh":"Atlantis"}'::jsonb,
  'https://www.atlantisstrength.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'CA' LIMIT 1),
  160,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'ATLANTIS');

UPDATE brands SET
  name = '{"ko":"아틀란티스","en":"Atlantis","ja":"アトランティス","zh":"Atlantis"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.atlantisstrength.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'CA' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 160 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'ATLANTIS';
...
SELECT
  'GYMLECO',
  '{"ko":"짐레코","en":"Gymleco","ja":"ジムレコ","zh":"Gymleco"}'::jsonb,
  'https://www.gymleco.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'SE' LIMIT 1),
  170,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'GYMLECO');

UPDATE brands SET
  name = '{"ko":"짐레코","en":"Gymleco","ja":"ジムレコ","zh":"Gymleco"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.gymleco.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'SE' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 170 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'GYMLECO';
...
SELECT
  'WATSON',
  '{"ko":"왓슨","en":"Watson Gym Equipment","ja":"ワトソン","zh":"Watson"}'::jsonb,
  'https://www.watsongym.co.uk',
  (SELECT id FROM countries WHERE UPPER(code) = 'AU' LIMIT 1),
  180,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'WATSON');

UPDATE brands SET
  name = '{"ko":"왓슨","en":"Watson Gym Equipment","ja":"ワトソン","zh":"Watson"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.watsongym.co.uk'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'AU' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 180 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'WATSON';
...
SELECT
  'TELJU',
  '{"ko":"텔주","en":"Telju","ja":"テルジュ","zh":"Telju"}'::jsonb,
  'https://www.telju.com',
  (SELECT id FROM countries WHERE UPPER(code) = 'ES' LIMIT 1),
  190,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'TELJU');

UPDATE brands SET
  name = '{"ko":"텔주","en":"Telju","ja":"テルジュ","zh":"Telju"}'::jsonb,
  website_url = COALESCE(website_url, 'https://www.telju.com'),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'ES' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 190 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'TELJU';
...
SELECT
  'NEWTECH',
  '{"ko":"뉴텍웰니스","en":"NEWTECH","ja":"ニューテック","zh":"NEWTECH"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  200,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'NEWTECH');

UPDATE brands SET
  name = '{"ko":"뉴텍웰니스","en":"NEWTECH","ja":"ニューテック","zh":"NEWTECH"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
...
SELECT
  'DRAX',
  '{"ko":"디랙스","en":"DRAX","ja":"DRAX","zh":"DRAX"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  210,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'DRAX');

UPDATE brands SET
  name = '{"ko":"디랙스","en":"DRAX","ja":"DRAX","zh":"DRAX"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 210 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'DRAX';
...
SELECT
  'LEXCO',
  '{"ko":"렉스코","en":"LEXCO","ja":"LEXCO","zh":"LEXCO"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  220,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'LEXCO');

UPDATE brands SET
  name = '{"ko":"렉스코","en":"LEXCO","ja":"LEXCO","zh":"LEXCO"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 220 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'LEXCO';
...
SELECT
  'BODYSTONE',
  '{"ko":"바디스톤","en":"BODYSTONE","ja":"ボディストーン","zh":"BODYSTONE"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  230,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'BODYSTONE');

UPDATE brands SET
  name = '{"ko":"바디스톤","en":"BODYSTONE","ja":"ボディストーン","zh":"BODYSTONE"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 230 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'BODYSTONE';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'FOCUS',
  '{"ko":"포커스","en":"FOCUS","ja":"FOCUS","zh":"FOCUS"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  240,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'FOCUS');

UPDATE brands SET
  name = '{"ko":"포커스","en":"FOCUS","ja":"FOCUS","zh":"FOCUS"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 240 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'FOCUS';
...
SELECT
  'MIGANG',
  '{"ko":"미강","en":"MIGANG","ja":"MIGANG","zh":"MIGANG"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  250,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'MIGANG');

UPDATE brands SET
  name = '{"ko":"미강","en":"MIGANG","ja":"MIGANG","zh":"MIGANG"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 250 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'MIGANG';
...
SELECT
  'TGS_STRENGTH',
  '{"ko":"TGS 스트렝스","en":"TGS Strength","ja":"TGS Strength","zh":"TGS Strength"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  260,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'TGS_STRENGTH');

UPDATE brands SET
  name = '{"ko":"TGS 스트렝스","en":"TGS Strength","ja":"TGS Strength","zh":"TGS Strength"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 260 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'TGS_STRENGTH';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'IKK_SPORTS',
  '{"ko":"IKK 스포츠","en":"IKK Sports","ja":"IKK Sports","zh":"IKK Sports"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  270,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'IKK_SPORTS');

UPDATE brands SET
  name = '{"ko":"IKK 스포츠","en":"IKK Sports","ja":"IKK Sports","zh":"IKK Sports"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 270 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'IKK_SPORTS';

INSERT INTO brands (code, name, website_url, country_id, sort_order, is_active)
SELECT
  'STEX',
  '{"ko":"스테ックス","en":"STEX","ja":"STEX","zh":"STEX"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  280,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'STEX');

UPDATE brands SET
  name = '{"ko":"스테ックス","en":"STEX","ja":"STEX","zh":"STEX"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 280 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'STEX';
...
SELECT
  'EDITION80',
  '{"ko":"에디션80","en":"Edition80","ja":"Edition80","zh":"Edition80"}'::jsonb,
  NULL,
  (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1),
  290,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM brands WHERE code = 'EDITION80');

UPDATE brands SET
  name = '{"ko":"에디션80","en":"Edition80","ja":"Edition80","zh":"Edition80"}'::jsonb,
  website_url = COALESCE(website_url, NULL),
  country_id = COALESCE(country_id, (SELECT id FROM countries WHERE UPPER(code) = 'KR' LIMIT 1)),
  sort_order = CASE WHEN sort_order = 0 THEN 290 ELSE sort_order END,
  is_active = TRUE,
  updated_at = NOW()
WHERE code = 'EDITION80';
