...
CROSS JOIN (VALUES
  ...
  ('HS_ISO_LATERAL_HIGH_ROW', 'male', 'beginner', 160, 170, 3, 2, NULL, 1, '최대', 25,
  ...
  ('HS_ISO_LATERAL_HIGH_ROW', 'male', 'intermediate', 170, 180, 5, 3, NULL, 2, '최대', 40,
    ...
    '{"en":["Do not round lower back"],"ko":["허리를 굽히지 마세요"],"ja":["腰を丸めない"],"zh":["不要弯腰弓背"]}'),
  ('HS_ISO_LATERAL_HIGH_ROW', 'male', 'advanced', 180, 190, 7, 4, NULL, 3, '최대', 55,
  ...
  ('HS_ISO_LATERAL_HIGH_ROW', 'female', 'intermediate', 155, 170, 4, 2, NULL, 1, '최대', 25,
  ...
  ('HS_SELECTORIZED_CHEST_PRESS', 'male', 'intermediate', 170, 180, 4, 3, NULL, 2, '최대', 50,
  ...
  ('HS_SELECTORIZED_CHEST_PRESS', 'female', 'beginner', 150, 165, 3, 2, NULL, 1, '최대', 20,
  ...
  -- HS_LEG_EXTENSION
  ('HS_LEG_EXTENSION', 'male', 'intermediate', 170, 180, 5, 4, 3, NULL, '최대', 45,
  ...
  ('HS_LEG_EXTENSION', 'female', 'intermediate', 155, 170, 4, 3, 2, NULL, '최대', 30,
  ...
  -- HS_LEG_CURL
  ('HS_LEG_CURL', 'male', 'intermediate', 170, 180, 5, 3, 4, NULL, '최대', 40,
  ...
  -- FW_DUMBBELL
  ('FW_DUMBBELL', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', 12,
  ...
  -- FW_BARBELL
  ('FW_BARBELL', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', 40,
  ...
  -- FW_KETTLEBELL
  ('FW_KETTLEBELL', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', 16,
  ...
  -- BW_PULL_UP
  ('BW_PULL_UP', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
  ...
  -- BW_CHIN_UP
  ('BW_CHIN_UP', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
  ...
  -- BW_DIPS
  ('BW_DIPS', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
  ...
  -- BW_PUSH_UP
  ('BW_PUSH_UP', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
  ...
  -- BW_SQUAT
  ('BW_SQUAT', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
  ...
  -- BW_LUNGE
  ('BW_LUNGE', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
  ...
  ('BW_BULGARIAN_SPLIT_SQUAT', 'male', 'intermediate', 160, 190, NULL, NULL, NULL, NULL, '최대', NULL,
