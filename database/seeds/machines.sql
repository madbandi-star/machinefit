...
CROSS JOIN (VALUES
  ...
  ('BODYWEIGHT', 'BW_STEP_UP', '{"ko":"스텝업","en":"Step-up","ja":"ステップアップ","zh":"踏步上台"}', 'legs', 'bodyweight', false, false, false, false, '최대'),
  ('BODYWEIGHT', 'BW_PLANK', '{"ko":"플랭크","en":"Plank","ja":"プランク","zh":"平板支撑"}', 'core', 'bodyweight', false, false, false, false, '최대'),
  ('BODYWEIGHT', 'BW_CRUNCH', '{"ko":"크런치","en":"Crunch","ja":"クランチ","zh":"卷腹"}', 'core', 'bodyweight', false, false, false, false, '최대'),
  ('BODYWEIGHT', 'BW_BURPEE', '{"ko":"버피","en":"Burpee","ja":"バーピー","zh":"波比跳"}', 'full_body', 'bodyweight', false, false, false, false, '최대'),
