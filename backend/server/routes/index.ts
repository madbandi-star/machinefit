...
import { brandFavoriteRouter } from './brand-favorite.routes.js';
...
import { machineShowcaseRouter } from './machine-showcase.routes.js';
...
import { timerHistoryRouter } from './timer-history.routes.js';
...
apiRouter.use('/brand-favorites', brandFavoriteRouter);
apiRouter.use('/history', historyRouter);
apiRouter.use('/gyms', gymRouter);
apiRouter.use('/meta', metaRouter);
apiRouter.use('/community/machine-showcase', machineShowcaseRouter);
...
apiRouter.use('/timer-history', timerHistoryRouter);
