...
const MOCK_DIRECTORY: GymDirectoryEntry[] = [
  ...
  {
    id: '00000000-0000-4000-8000-00000000d009',
    name: '밀리언짐 상계점',
    stateName: '서울특별시',
    cityName: '노원구',
    locationLabel: '서울특별시 노원구',
  },
  {
    id: '00000000-0000-4000-8000-00000000d00a',
    name: '자마이카 신림점',
    stateName: '서울특별시',
    cityName: '관악구',
    locationLabel: '서울특별시 관악구',
  ...
  {
    id: '00000000-0000-4000-8000-00000000d00b',
    name: '올라잇짐 만덕점',
    stateName: '부산광역시',
    cityName: '북구',
    locationLabel: '부산광역시 북구',
  },
  {
