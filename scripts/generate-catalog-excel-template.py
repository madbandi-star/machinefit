...
def sheet_guide(wb: Workbook):
    ...
    lines = [
        ...
        ["데이터만(미표시) — 머신 description, howTo, beginner/intermediate/advanced/pro Tips, recommendedExperience, 이미지 갤러리/alt, YouTube"],
        [""],
        ["문의/확장"],
...
def sheet_dictionary(wb: Workbook):
    ...
    rows = [
        ...
        ["머신", "intermediateTips.ko", "중급자팁(한글)", "Intermediate Tips KO", "상세(예정)", "데이터만", "선택", "줄바꿈 문장목록", "03_머신", "향후 사용"],
        ["머신", "intermediateTips.en", "중급자팁(영문)", "Intermediate Tips EN", "상세(예정)", "데이터만", "선택", "줄바꿈 문장목록", "03_머신", ""],
        ["머신", "advancedTips.ko", "상급자팁(한글)", "Advanced Tips KO", "상세(예정)", "데이터만", "선택", "줄바꿈 문장목록", "03_머신", "향후 사용"],
        ["머신", "advancedTips.en", "상급자팁(영문)", "Advanced Tips EN", "상세(예정)", "데이터만", "선택", "줄바꿈 문장목록", "03_머신", ""],
        ["머신", "proTips.ko", "프로팁(한글)", "Pro Tips KO", "상세(예정)", "데이터만", "선택", "줄바꿈 문장목록", "03_머신", "향후 사용"],
        ["머신", "proTips.en", "프로팁(영문)", "Pro Tips EN", "상세(예정)", "데이터만", "선택", "줄바꿈 문장목록", "03_머신", ""],
...
def sheet_machines(wb: Workbook):
    ...
    headers = [
        ...
        "beginnerTips_ko (줄바꿈)",
        "beginnerTips_en (줄바꿈)",
        "intermediateTips_ko (줄바꿈)",
        "intermediateTips_en (줄바꿈)",
        "advancedTips_ko (줄바꿈)",
        "advancedTips_en (줄바꿈)",
        "proTips_ko (줄바꿈)",
        "proTips_en (줄바꿈)",
...
def sheet_example(wb: Workbook):
    ...
    steps = [
        ...
        "- 사용방법(howTo), 초보/중급/상급/프로팁, 머신소개, 추천경험레벨, 추가 이미지/유튜브",
    ]
